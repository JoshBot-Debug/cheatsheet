...
copper lines and pins on your RAM sticks. Instead, it hands your program a [**Virtual Address**](/c++/Hardware/RAM#virtual-address).
...
* **The Page Table**: To translate your program's [**virtual address**](/c++/Hardware/RAM#virtual-address) (e.g., `0x7FFF54B2`) into the actual location on the physical RAM stick (e.g., `0x1A2B3C4D`), 
...
* **Instructions**: Instructions are stored in RAM and have [**virtual addresses**](/c++/Hardware/RAM#virtual-address)
* **Data**: Data is stored in RAM and has [**virtual addresses**](/c++/Hardware/RAM#virtual-address).

Both **instructions & data** [**virtual addresses**](/c++/Hardware/RAM#virtual-address) are fetched by the **MMU** into **ITLB** & **DTLB**.
...
Caches virtual-to-physical translations for **executable code instructions**. Compiled machine instructions are saved as [**virtual addresses**](/c++/Hardware/RAM#virtual-address) too, 
...
instruction paths (like **virtual method tables** or **heavy callback loops**). Instructions are also stored as [**virtual addresses**](/c++/Hardware/RAM#virtual-address) across different 4 KB 
...
When you read a 32-bit integer, both the 4 KB page (only the [**virtual address**](/c++/Hardware/RAM#virtual-address) mapping) and 64 byte cache line is loaded into memory, 
...
* You **load** the **4 KB page** into the **TLB** to map the [**virtual addresses**](/c++/Hardware/RAM#virtual-address) to physical addresses.
...
1. The **MMU** looks up the [**virtual address**](/c++/Hardware/RAM#virtual-address) in the L1 **DTLB**.
2. If it misses, it checks the **STLB**. If that misses, it performs a [**hardware page walk**](/c++/Hardware/RAM#virtual-address) across the **4 KB page tables stored in DRAM**. 
...
Read from [**Virtual address**](/c++/Hardware/RAM#virtual-address) till [**CR3 Register**](/c++/Hardware/RAM#the-cr3-register)
