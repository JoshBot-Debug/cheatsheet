...
[ ] Study L1/L2/L3 cache line architecture (typically 64 bytes) and how data is fetched into cache blocks.

[ ] Understand the mechanics of False Sharing in multi-threaded environments (multiple cores modifying independent variables residing on the same cache line).

[ ] Learn how to use std::hardware_destructive_interference_size (C++17) to properly align structures and prevent false sharing.
...
[ ] Study the Translation Lookaside Buffer (TLB) and how hardware caches virtual-to-physical address translations.

[ ] Deep dive into page faults (minor vs. major) and how they introduce latency spikes.

[ ] Explore Large/Huge Pages (2MB/1GB instead of the standard 4KB) and how they minimize TLB misses in memory-heavy or networking systems.
